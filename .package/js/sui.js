...
},{"./affix":1,"./alert":2,"./autocomplete":3,"./button":4,"./carousel":5,"./checkbox":6,"./collapse":7,"./datepicker":8,"./dropdown":9,"./modal":10,"./pagination":11,"./popover":12,"./scrollspy":13,"./tab":15,"./timepicker":16,"./tooltip":17,"./transition":18,"./tree":19,"./validate":21,"./validate-rules":20}],15:[function(require,module,exports){
/* ========================================================
...
!function ($) {
  ...
  * ========================= */
  ...
  $.fn.tooltip.defaults = {
    animation: true
  , type: 'default'   //tip 类型 {string} 'default'|'primary'|'attention'|'info'|'confirm' ,区别见demo
  , placement: 'top'
